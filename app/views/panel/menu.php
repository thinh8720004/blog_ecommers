            ...
            <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        ...
                        <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>post/listCategory">List Article
                                Category</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>product/addCategory">Add Product
                                Portfolio</a></li>
                        <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>product/listCategory">List Product
                                Portfolio</a></li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="navbarDropdown">
                        <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>product/addProduct">Add Product</a>
                        </li>
                        <li><a class="dropdown-item" href="<?php echo BASE_URL; ?>product/listProduct">List Product</a>
                        </li>
                    </ul>
                </li>
                <li class="nav-item dropdown">
