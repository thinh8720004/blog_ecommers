                    ...
                    <div class="wrapper_all_main_right no-padding-left" style="width:100%;">
                        ...
                        <div class="breadcrumbs">
                            <ol itemscope itemtype="http://schema.org/BreadcrumbList">
                                ...
                                <li itemprop="itemListElement" itemscope itemtype="http://schema.org/ListItem">
                                    <a itemprop="item"
                                        href="<?php echo BASE_URL; ?>products/category/<?php echo $id_cate ?>">
                                        <span itemprop="name">
                                        ...
                                        <div class="pro-des-sum">
                                            <div class="price">
                                                <p class="code_skin" style="margin-bottom:10px">
                                                    <span>ID Product: <a href="chitietsp.php">CRW-W06</a> | Brand: <a
                                                            href="">Comrack</a></span>
                                                </p>
                                    ...
                                    <div class="ct">
                                        ...
                                        <div class="wp_a">
                                            <button type="submit" class="btn btn-success"
                                                style="font-weight: bold; font-size: 18px;"><span>Order</span></button>
                                            <button type="button" class="btn btn-danger"
                                                style="font-weight: bold; font-size: 18px;">Call Now</button>
                                ...
                                <div class="content-des-pro-suport">
                                    <div class="box-setup">
                                        ...
                                        <div class="info-setup">
                                            <div class="row-setup">
                                                <p style="text-align:justify">Please contact sales staff at the following
                                                    Hotline phone number:</p>
                                                <p><span style="color:#d50100">0123 456 789</span>&nbsp; for more details
                                                    about Product accessories.</p>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="info-prod prod-price freeship">
                                        <span class="title">
                                            <p>
                                                You will receive free delivery within the inner city area of ​​Da NangNang
                                                City when purchasing this product.
                                            </p>
                                        </span>
                        ...
                        <div class="grids_in">
                            <div class="content">
                                ...
                                <div class="img-right-pro">
                                    ...
                                    <a href="sanpham.php">
                                        ...
                                        <img class="lazy img-pro content-image"
                                            src="<?php echo BASE_URL ?>/public/uploads/product/imageproduct /<?php echo $relate['image_product'] ?>"
                                            data-original="<?php echo BASE_URL ?>/public/uploads/product/imageproduct /<?php echo $relate['image_product'] ?>"
                                            alt="<?php echo $relate['title_product'] ?>" />
                                    </a>
                                ...
                                <div class="name-pro-right">
                                    <a
                                        href="<?php echo BASE_URL ?>products/productDetails/<?php echo $relate['id_product'] ?>">
