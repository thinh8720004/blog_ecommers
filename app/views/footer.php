<footer>
                            ...
                            <li>
                                <a href=".">
                                    ...
                                    <p class="text_li">
                                        ...
                                        <span class="text_small">(From 8:00 a.m. to 8:00 p.m. all days)</span>
                                    </p>
                                </a>
                            </li>
                            <div class="clear"></div>
                            <li><a><i class="fa fa-envelope" aria-hidden="true"></i> interiorthinhtu@gmail.com</a></li>
                            <li><a><i class="fa fa-mouse-pointer" aria-hidden="true"></i> <?php echo BASE_URL ?></a></li>
                        </ul>
                    </div>
                </div>
            </div>
        ...
        <div class="bg_in">
            <div class="footer">
                <div class="infor_company">
                    ...
                    <p class="note_mst">Business Registration Certificate No: 7777777. First issue: October 10, 2015. Changed: October 10, 2023. Place of issue: Business registration office, Department of Planning and Investment, Da Nang City</p>
                </div>
                <div class="footer-col">
                    <h4>Headquarters</h4>
    ...
    <div class="clear"></div>
    <div class="copyright">
        <h4 class="tkw9999">&copy; Copyright belongs to Designed by ThinhTu  <a href="<?php echo BASE_URL ?>" rel="dofollow" target="_blank">Web design</a> By <a href="<?php echo BASE_URL ?>">WebDesignThinhTu.com</a></h4>
    </div>
</footer>
<div class="coccoc-alo-phone coccoc-alo-green coccoc-alo-show" id="coccoc-alo-phoneIcon">
    <a href="tel:0123-456-789" title="Call us now">
