                ...
                <div class="footer-col">
                    ...
                    <div class="footer-col-content">
                        <ul class="icon_list">
                            ...
                            <li><a><i class="fa fa-mouse-pointer" aria-hidden="true"></i> <?php echo BASE_URL ?></a>
                            </li>
                        </ul>
                    </div>
                </div>
        ...
        <div class="bg_in">
            <div class="footer">
                <div class="infor_company">
                    ...
                    <p class="note_mst">Business Registration Certificate No: 7777777. First issue: October 10, 2022. Changed: October 10, 2023. Place of issue: Room
