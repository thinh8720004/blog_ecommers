...
<body>
                                 ...
                                 <ul>
                                    <li class='active has-sub'>
                                       ...
                                       <div class="menu_sub_all">
                                          <span
                                             style="color: #000;position: relative;font-size: 17px;font-weight: 700;">Apple</span>
                                          <ul>
                                             <li>
                                          ...
                                          <span
                                             style="color: #000;position: relative;font-size: 17px;font-weight: 700;">Samsung</span>
                                          <ul>
                                             <li>
                        ...
                        <div class="content-des-pro_in">
                           <div class="pro-des-sum">
                              ...
                              <div class="color_price">
                                 <span class="title_price bg_green">Giá bán</span> 17,960,000 <span>vnđ</span>. (GIÁ
                                 CHƯA VAT)
                                 <div class="clear"></div>
                              </div>
                              <div class="color_price">
                     ...
                     <div class="content-des-pro-suport">
                        <div class="box-setup">
                           ...
                           <div class="info-setup">
                              <div class="row-setup">
                                 <p style="text-align:justify">Quý khách vui lòng liên hệ với nhân viên bán hàng theo số
                                    điện thoại Hotline sau :</p>
                                 <p><span style="color:#d50100">0932 023 992</span>&nbsp;để biết thêm chi tiết về Phụ
                                    kiện sản phẩm.</p>
                              </div>
                           </div>
                        </div>
                           ...
                           <div class="grids_in">
                              <div class="content">
                                 <div class="img-right-pro">
                                    ...
                                    <a href="sanpham.php">
                                       <img class="lazy img-pro content-image" src="image/iphone.png"
         ...
         <div class="bg_in">
            <div class="footer">
               <div class="infor_company">
                  ...
                  <a href=""><img src="image/da-dang-ky-voi-bo-cong-thuong.png" alt="da-dang-ky-voi-bo-cong-thuong.png"
                        class="cangiua" /></a>
   ...
   <div
      style="height: 1840px;position: fixed;width: 100%;top: 0px;left: 0px;right: 0px;bottom: 0px;z-index: 1001;background: #000 none repeat scroll 0% 0%;opacity: 0.3;display: none;text-align:center"
      id="khungnen"></div>
